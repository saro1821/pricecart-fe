...
export const updateProduct  =  (id, productData) => async (dispatch) => {
    ...
    try {  
        ...
        const { data }  =  await axios.put(`${process.env.REACT_APP_BACKEND_URL}/api/v1/admin/product/${id}`, productData);
...
export const getReviews =  id => async (dispatch) => {
    ...
    try {  
        ...
        const { data }  =  await axios.get(`${process.env.REACT_APP_BACKEND_URL}/api/v1/admin/reviews`,{params: {id}});
...
export const deleteReview =  (productId, id) => async (dispatch) => {
    ...
    try {  
        ...
        await axios.delete(`${process.env.REACT_APP_BACKEND_URL}/api/v1/admin/review`,{params: {productId, id}});
