...
export const loadUser =  async (dispatch) => {
    ...
    try {
        ...
        const { data }  = await axios.get(`${process.env.REACT_APP_BACKEND_URL}/api/v1/myprofile`);
...
export const deleteUser = id => async (dispatch) => {
    ...
    try {
        ...
        await axios.delete(`${process.env.REACT_APP_BACKEND_URL}/api/v1/admin/user/${id}`);
